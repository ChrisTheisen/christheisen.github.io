...
const help = [
	{t:'General', c:[
		...
		'',
		'<?> Help button in the upper right will show the help contents for the tab you are on.',
		...
		'(i) Info Circles can be hovered over for extra information or explanations related to the nearby page element.',
		'',
		'Misc:',
	...
	{t:'Number Syntax', c:[
		'This game uses "," as a thousands separator and "." to denote the whole vs fractional components.',
		'1,500 = 1500 = one thousand five hundred',
		'1.500 = 1.5 = one and one half',
		'',
		'Since this game supports a varity of bases (See Settings) the exponent format to denote large numbers using "e" (5e3 = 5,000) doesn\'t always work.',
		'For example 1480 in Base32 is 1e8 or 23043 in Base64 is 5e3.',
		'',
		'This game uses << and >> to denote shifting the number to the left or right.',
		'Examples:',
	...
	{t:'Hotkeys', c:[
		'A lot of the game can be done via the keyboard but a few tasks require a mouse.',
		'',
		'Menu navigation:',
	...
	{t:'Manage', c:[
		...
		'[≡] : this button will show a modal to view all transmuters, both input and output, related to an item',
		'',
	...
	{t:'Settings', c:[
		...
		'Show introduction hints with a green border: This toggles the contextual explanations with a green border.',
		'Show flavor text and bonus info: This toggles the short info snippets with educational and game information.',
		'Show Used-In Spoiler Warning: This toggles the spoiler warning message and show the Used In list by default.',
		...
		'Enhancement Scaling: A bigger number increases trasmuter outputs and makes the game progression easier/faster',
