...
const Mg = {
	id:'m_e', n:'Magnesium', u:false, c:[items.Mg24,items.Mg25,items.Mg26],
...
const Al = {
	id:'m_f', n:'Aluminum', u:false, c:[items.Al27],
...
const Si = {
	id:'m_g', n:'Silicon', u:false, c:[items.Si28,items.Si29,items.Si30],
...
const P = {
	id:'m_h', n:'Phosphorus', u:false, c:[items.P31],
	info: ['Phosphorus is used in matches.']
};
const S = {
	id:'m_i', n:'Sulfur', u:false, c:[items.S32,items.S33,items.S34,items.S36],
	info: ['Sulfur is found pure in nature, likely from volcanoes.']
};
const Cl = {
	id:'m_j', n:'Chlorine', u:false, c:[items.Cl35,items.Cl37],
	info: ['Chlorine is a commonly used to purify drinking water and swimming pools.']
};
const Ar = {
	id:'m_k', n:'Argon', u:false, c:[items.Ar36,items.Ar38,items.Ar40],
	info: ['Argon is intert and colorless but glows blue when excited by an electrical charge.']
};
const K = {
	id:'m_l', n:'Potassium', u:false, c:[items.K39,items.K40,items.K41],
	info: ['Potassium is an electrolyte the body needs to function but is harmful in larger quantities.']
};
const Ca = {
	id:'m_m', n:'Calcium', u:false, c:[items.Ca40,items.Ca42,items.Ca43,items.Ca44,items.Ca46,items.Ca48],
	info: ['Calcium in it\'s pure form is rare, it is often associated with bone strength.']
};
const Sc = {
	id:'m_n', n:'Scandium', u:false, c:[items.Sc45],
	info: ['Scandium has few uses outside of research.']
};
const Ti = {
	id:'m_o', n:'Titanium', u:false, c:[items.Ti46,items.Ti47,items.Ti48,items.Ti49,items.Ti50],
...
const In = {
	id:'m_P', n:'Indium', u:false, c:[items.In113,items.In115],
	info: ['Indium is mostly used in electronics like touch screens and solar panels.']
};
const Sn = {
	id:'m_Q', n:'Tin', u:false, c:[items.Sn112,items.Sn114,items.Sn115,items.Sn116,items.Sn117,items.Sn118,items.Sn119,items.Sn120,items.Sn122,items.Sn124],
	info: ['Tin has many uses from food storage to pewter. Bronze was one of the first alloys, made with copper and tin.']
};
const Sb = {
	id:'m_R', n:'Antimony', u:false, c:[items.Sb121,items.Sb123],
...
const Sm = {
	id:'m_12', n:'Samarium', u:false, c:[items.Sm144,items.Sm147,items.Sm148,items.Sm149,items.Sm150,items.Sm152,items.Sm154],
	info: ['Samarium is used in an alloy with cobalt in microwaves.']
};
const Eu = {
	id:'m_13', n:'Europium', u:false, c:[items.Eu151,items.Eu153],
	info: ['Europium glows red under UV light an dis used in printing of euro banknotes.']
};
const Gd = {
	id:'m_14', n:'Gadolinium', u:false, c:[items.Gd152,items.Gd154,items.Gd155,items.Gd156,items.Gd157,items.Gd158,items.Gd160],
	info: ['Gadolinium is used in small amounts in iron and chromium alloys.']
};
const Tb = {
	id:'m_15', n:'Terbium', u:false, c:[items.Tb159],
	info: ['Terbium is used in some x-ray devices and lasers.']
};
const Dy = {
	id:'m_16', n:'Dysprosium', u:false, c:[items.Dy156,items.Dy158,items.Dy160,items.Dy161,items.Dy162,items.Dy163,items.Dy164],
	info: ['Dysprosium is mainly used in alloys with neodymium magnets.']
};
const Ho = {
	id:'m_17', n:'Holmium', u:false, c:[items.Ho165],
	info: ['Holmium can absorb neutrons and is used in nuclear reactors.']
};
const Er = {
	id:'m_18', n:'Erbium', u:false, c:[items.Er162,items.Er164,items.Er166,items.Er167,items.Er168,items.Er170],
	info: ['Erbium can be used in alloys to reduce hardness and improve workability.']
};
const Tm = {
	id:'m_19', n:'Thulium', u:false, c:[items.Tm169],
	info: ['Thulium is used in some medical x-ray machines.']
};
const Yb = {
	id:'m_1a', n:'Ytterbium', u:false, c:[items.Yb168,items.Yb170,items.Yb171,items.Yb172,items.Yb173,items.Yb174,items.Yb176],
	info: ['Ytterbium can be used in some memory devices and as an industrial catalyst.']
};
const Lu = {
	id:'m_1b', n:'Lutetium', u:false, c:[items.Lu175,items.Lu176],
	info: ['Lutetium is mostly used in research.']
};
const Hf = {
	id:'m_1c', n:'Hafnium', u:false, c:[items.Hf174,items.Hf176,items.Hf177,items.Hf178,items.Hf179,items.Hf180],
	info: ['Hafnium is used in nuclear submarines and plasma welding torches.']
};
const Ta = {
	id:'m_1d', n:'Tantalum', u:false, c:[items.Ta181],
	info: ['Tantalum is used as an insulating coating in electronics.']
};
const W = {
	id:'m_1e', n:'Tungsten', u:false, c:[items.W180,items.W182,items.W183,items.W184,items.W186],
	info: ['Tungsten has the highest melting point of all metals and is used in incandescent light bulbs.']
};
const Re = {
	id:'m_1f', n:'Rhenium', u:false, c:[items.Re185,items.Re187],
	info: ['Rhenium has a high melting point and is often combined in alloys with tungsten and molybdenum.']
};
const Os = {
	id:'m_1g', n:'Osmium', u:false, c:[items.Os184,items.Os186,items.Os187,items.Os188,items.Os189,items.Os190,items.Os192],
	info: ['Osmium has few uses including fountain pen tips and electrical contacts.']
};
const Ir = {
	id:'m_1h', n:'Iridium', u:false, c:[items.Ir191,items.Ir193],
	info: ['Iridium is the most corosion resistant material known and is used in the standard meter bar.']
};
const Pt = {
	id:'m_1i', n:'Platinum', u:false, c:[items.Pt190,items.Pt192,items.Pt194,items.Pt195,items.Pt196,items.Pt198],
	info: ['Platinum is mostly used in catalytic converters but is also in jewellery and electronics.']
};
const Au = {
	id:'m_1j', n:'Gold', u:false, c:[items.Au197],
	info: ['Gold is often used in jewellery. 24-carat gold is pure gold, but it is often used as an alloy to improve durability.']
};
const Hg = {
	id:'m_1k', n:'Mercury', u:false, c:[items.Hg196,items.Hg198,items.Hg199,items.Hg200,items.Hg201,items.Hg202,items.Hg204],
	info: ['Mercury is a heavy liquid metal and is being phased out of many uses due to toxicity.']
};
const Tl = {
	id:'m_1l', n:'Thallium', u:false, c:[items.Tl203,items.Tl205],
	info: ['Thallium use is limited due to toxicity, but it is used in photoelectric cells.']
};
const Pb = {
	id:'m_1m', n:'Lead', u:false, c:[items.Pb204,items.Pb206,items.Pb207,items.Pb208],
...
const Chalcogen = {
	id:'m_24', n:'Chalcogen', u:false, c:[O,S,Se,Te,Po],
...
const TransitionMetal = {
	id:'m_2b', n:'Transition Metal', u:false, c:[TMP4,TMP5,TMP6,TMP7],
...
const aliphaticAmide = {
	id:'m_2f', n:'Aliphatic Amide', u:false, c:[items.acetamide],//from acetic acid + ammonia = acetamide + water
	info: ['Aliphatic amides bond the nitrogen to an alkyl group.']
}
const aromaticAmide = {
	id:'m_2g', n:'Aromatic Amide', u:false, c:[items.benzamide],//from benzoic acid + ammonia = benzamide + water
...
const alkane = {
	id:'m_2h', n:'Alkane', u:false, c:[items.methane,items.ethane,items.propane,items.butane],
...
const alkene = {
	id:'m_2i', n:'Alkene', u:false, c:[items.methene,items.ethene,items.propene,items.butene],
	info: ['Alkenes are hydrocarbons with at least one carbon atom double bonded to another carbon atom.']
}
const alkyne = {
	id:'m_2j', n:'Alkyne', u:false, c:[items.ethyne,items.propyne,items.butyne],
	info: ['Alkenes are hydrocarbons with at least one carbon atom triple bonded to another carbon atom.']
}
const benzeneRing = {
	id:'m_2k', n:'Benzene Ring', u:false, c:[items.benzene,items.toluene],
	info: ['A benzene ring contains a cyclic hydrocarbon.']
}
const amine = {
	id:'m_2l', n:'Amine', u:false, c:[primaryAmine,secondaryAmine,tertiaryAmine],
	info: ['Amines contain a nitrogen and hydrogen bonded to a hydrocarbon.']
}
const alcohol = {
	id:'m_2m', n:'Alcohol', u:false, c:[items.methanol,items.ethanol,items.propanol,items.coniferylAlcohol,items.sinapylAlcohol,items.coumerylAlcohol],//isopropanol,items.butanol,items.glycerol,items.propylene glycol
	info: ['Alcohols are an oganic compound that contain a hydroxyl group OH bonded to a carbon atom.']
}
const hydroxyl = {
	id:'m_2n', n:'Hydroxyl', u:false, c:[items.coniferylAlcohol,items.phenol],
	info: ['Hydroxyls are organic compounds with an Oxygen atom bonded to a Hydrogen atom (-OH).']
}
const carbonyl = {
	id:'m_2o', n:'Carbonyl', u:false, c:[items.phenylalanine],
...
const ether = {
	id:'m_2p', n:'Ether', u:false, c:[],
	info: ['']
}
const alkylHalide = {
	id:'m_2q', n:'Alkyl Halide', u:false, c:[],
	info: ['']
}
const thiol = {
	id:'m_2r', n:'Thiol', u:false, c:[],
	info: ['']
}
const aldehyde = {
	id:'m_2s', n:'Aldehyde', u:false, c:[items.formeldehyde],
	info: ['Aldehydes have a carbonyl group conded to a hydrogen atom.']
}
const ketone = {
	id:'m_2t', n:'Ketone', u:false, c:[],
	info: ['']
}
const ester = {
	id:'m_2u', n:'Ester', u:false, c:[],
	info: ['']
}
const carboxylicAcid = {
	id:'m_2v', n:'Carboxylic Acid', u:false, c:[items.aceticAcid,items.formicAcid,items.benzoicAcid],
	info: ['Carboxylic acids are generally weak acids that contain a carboxyl group of COOH.']
}
const amide = {
	id:'m_2w', n:'Amide', u:false, c:[aliphaticAmide,aromaticAmide],
	info: ['Amides contain a carbonyl group C=0 bonded to a nitrogen atom.']
}
const nitrile = {
	id:'m_2x', n:'Nitrile', u:false, c:[],
	info: ['Nitriles have a carbon atom triple bonded to a nitrogen atom.']
}

const monosaccharide = {
	id:'m_2y', n:'Monosaccharide', u:false, c:[items.glucose,items.fructose,items.sucrose,items.ribose,items.xylose,items.mannose,items.galactose,items.arabinose],
	info:['Monosaccharides are a simple form of carbohydrates and are often called simple sugars.']
}
const polysaccharide = {
	id:'m_2z', n:'Polysaccharide', u:false, c:[items.cellulose,items.glycogen,items.hemicellulose],
...
const organicFunctionalGroup = {
	id:'m_2D', n:'Functional Groups', u:false, c:[alkane,alkene,alkyne,benzeneRing,amine,alcohol,hydroxyl,carbonyl,ether,alkylHalide,thiol,aldehyde,ketone,ester,carboxylicAcid,amide,nitrile],
...
const complexOrganicMaterial = {
	id:'m_2E', n:'Complex Material', u:false, c:[lignin,woodMolecule],
...
const organic = {
	id:'m_2F', n:'Organic Compounds', u:false, c:[organicFunctionalGroup,carbohydrate,complexOrganicMaterial],
	info:['Organic compounds contain bonded carbon and hydrogen atoms along with other elements.']
}

const binaryHydride = {
	id:'m_2G', n:'Binary Hydride', u:false, c:[items.ammonia,items.water,items.heavyWater,items.tritiatedWater,items.hydronium],
	info:['Binary hydrides contain hydrogen and one other element.']
}
const binaryOxide = {
	id:'m_2H', n:'Binary Oxide', u:false, c:[items.water,items.carbonMonoxide,items.carbonDioxide,items.heavyWater,items.tritiatedWater,items.hydronium],
	info:['Binary oxides contain hydrogen and one other element.']
}

const steel = {
	id:'m_2I', n:'Steel', u:false, c:[items.mildSteel,items.highSteel],
...
const simpleCompounds = {
	id:'m_2P', n:'Simple Compounds', u:false, c:[allotrope,binaryCompound],
	info:['Simple Compounds are still made on a molecular level and have few elements.']
}


const inorganic = {
	id:'m_2Q', n:'Inorganic Compounds', u:false, c:[simpleCompounds,metalAlloys,salt,acid,base],
	info:['Inorganic compounds do not contain carbon-hydrogen bonds.']
}

const woodMotes = {
	id:'m_2R', n:'Motes', u:false, c:[items.hardwoodFiber,items.softwoodFiber,items.hardwoodChip,items.softwoodChip,items.hardwoodPulp,items.softwoodPulp],
	info:['Wood Motes are small pieces of wood.']
}
const lumber = {
	id:'m_2S', n:'Lumber', u:false, c:[items.hardwood5x10x3,items.softwood5x10x3],
...
const paper = {
	id:'m_2T', n:'Paper', u:false, c:[items.paperA4,items.paperA3,items.paperA2,items.paperA1,items.paperA0],
	info:['There are many types of paper made with different types of pulp.', ]
}
const woodHuman = {
	id:'m_2U', n:'Wood', u:false, c:[woodMotes,paper,lumber],
	info: ['Wood is mostly composed of cellulose, hemicellulose, and lignin.', 'There are many types of wood, this game has some.']
}
const paperMaking = {
	id:'m_2V', n:'Paper Making', u:false, c:[items.whiteLiquorMote,items.whiteLiquor,items.blackLiquor,paper],
	info: ['Chemicals used in paper making.']
}
const industrial = {
	id:'m_2W', n:'Industrial', u:false, c:[paperMaking],
...
const atomic = {
    ...
    info: ['Atoms are basic elements that are the building blocks for molecules. They have a nucleus, which is made of baryons (protons and neutrons), and are `orbited` by electrons.', 
		'The nucleus is held together by the Nuclear Force (sometimes called the Strong Nuclear Force) which is a residual effect of the Strong Force which holds the baryons together.',
		'Many elements have multiple isotopes; for simplicity in this game most molecule recipes uses the most abundant isotope.'],
...
const help = [
	...
	{t:'Hotkeys', c:[
		...
		'HINT: The hotkeys [items.ALT+1, 0, -, 1] will goto the item for upgrade 1, create it if you can, go back to this tab, and buy the upgrade if you can',
		'|',
		'Settings',
	...
	{t:'Discover', c:[
		...
		'|',
		'You can [items.Get Recipe] approximately every 30 seconds. After about a 30 seconds the recipe will clear and the button will be available again.',
		'You can add the generated recipe inputs to the Matter Mutator with the (+>) button in the [items.Get Recipe] area if available.',
	...
	{t:'Enhance', c:[
		'This tab allows you to significantly break conservation of mass by multiplying generator outputs.',
		'This does not change the flow limits. It multiplies the created amount by the effect power.',
		'|',
		'Manual Output : Multiplies a generator output when manually run with the (->) button.',
		'Gen. Output : Increases all generator output, this multiplies both manually run and automatic.',
		'Gen. Cost : Multiplies generator upgrade costs.',
		'Enhancements : Increases the power of the other enhancements.',
		'|',
	...
	{t:'Settings', c:[
		...
		'Cheater Mode: When this is checked input items are not used in generators.',
