...
const help = [
	...
	{t:'What should I do now?', c:[
		'There isn\'t a way to win this game. I\'m trying to appeal to people who want continuous growth; never-ending creation out of nothing: no resets, no prestiges, just pure unadulterated item generation.',
		'',
		...
		'',
		'If the game is progressing too slowly check the settings, they can significantly increase the rate things are generated.',
	...
	{t:'Discover', c:[
		...
		'Example: The H2O generator requires two Hydrogens and one Oxygen to create but you only need to have one of each item in order to discover H2O',
		'',
	...
	{t:'Manage', c:[
		...
		'',
		'> NOTE: Some generators have bulk mass as an input. The Demand and Used standardizes the inputs to be the equivalent amount of items.',
