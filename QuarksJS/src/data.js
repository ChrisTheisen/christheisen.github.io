...
const tabs = [
	...
	{id:'M_2', n:'Manage', u:false, info:['If demand is greater than created you have a deficit.'], intro:'This is a central location to monitor item flow. This table is one of the few places that will only update when "Refresh Table" is clicked.'},
...
const help = [
	...
	{t:'Hotkeys', c:[
		...
		'|',
		'Create',
		'0: Manually generate all recipes with sufficient input resources.',
		'1: Upgrade all generators with sufficient resources.',
		'2: Focus Flow input on the first generator that is above level 0.',
		'|',
		'Discover',
