...
const audio = new Audio("Great_Vacation.mp3");

//TODO: ability to mute playing alarm
//TODO: progress bar to ding dong
...
class Timer{
    ...
    isNow = function(){
        return Math.abs(d - this.time) < 1000
    }
...
function addTimer() {
    timers.push(new Timer(input.value, label.value));
}
